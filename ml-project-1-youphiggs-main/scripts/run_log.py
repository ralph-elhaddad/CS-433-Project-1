...
if __name__ == "__main__":
    ...
    # train the model
    print("\n>>> begin training on logistic model")
    ...
    w_opt = logstic_regression(
        y, tX_poly, max_iter=501, gamma=0.5, isplot=False, conv_threshold=1e-6, maxstep=0.5
    )
